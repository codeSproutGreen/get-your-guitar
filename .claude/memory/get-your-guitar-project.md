...
- **M0 scaffold implemented 2026-09-18 on SDS PC** (Gradle 9.7.0, AGP 9.4.0, Kotlin 2.4.20, Compose BOM 2026.09.00, JUnit 6.1.3). **compileSdk is 37, not the spec's 36** — androidx.core 1.19 / Compose 1.12 require API 37; targetSdk 36 unchanged. **minSdk lowered 33→31 on 2026-09-21** because the SDS PC test phone is a Galaxy S10e on Android 12 (API 31); nothing in the v1 design needs API 32/33. On-device launch not yet verified.
